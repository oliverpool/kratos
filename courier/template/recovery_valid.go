...
func (t *RecoveryValid) EmailSubject() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("recovery", "valid", "email.subject.gotmpl"), t.m)
}

func (t *RecoveryValid) EmailBody() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("recovery", "valid", "email.body.gotmpl"), t.m)
}

func (t *RecoveryValid) EmailBodyPlaintext() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("recovery", "valid", "email.body.plaintext.gotmpl"), t.m)
}
