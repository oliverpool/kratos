...
func (t *VerificationInvalid) EmailSubject() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("verification", "invalid", "email.subject.gotmpl"), t.m)
}

func (t *VerificationInvalid) EmailBody() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("verification", "invalid", "email.body.gotmpl"), t.m)
}

func (t *VerificationInvalid) EmailBodyPlaintext() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("verification", "invalid", "email.body.plaintext.gotmpl"), t.m)
}
