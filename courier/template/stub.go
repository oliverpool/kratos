...
func (t *TestStub) EmailSubject() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("test_stub", "email.subject.gotmpl"), t.m)
}

func (t *TestStub) EmailBody() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("test_stub", "email.body.gotmpl"), t.m)
}

func (t *TestStub) EmailBodyPlaintext() (string, error) {
	return loadTextTemplate(t.c.CourierTemplatePath("test_stub", "email.body.plaintext.gotmpl"), t.m)
}
